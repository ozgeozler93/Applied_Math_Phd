...
if __name__ == '__main__':
    ...
    # n_classes: 1 for binary segmentation (mask vs. background)
    model = UNet(n_channels=3, n_classes=1)
    
    # Create a dummy input tensor to test the model
    # The input size should match the size of your images after resizing
    ...
    # The output shape should be (batch_size, n_classes, height, width)